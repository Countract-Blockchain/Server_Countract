...
from modules.utils import rgb_to_binary, add_leading_zeros

def encode_image(img_visible, img_hidden):
    output_path = 'F:/Project/Countract/images/encoded_img.png'
